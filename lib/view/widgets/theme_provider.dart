...
class MyThemes {
  static final darkTheme = ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(backgroundColor: Color.fromARGB(1, 33, 33, 33), selectedItemColor: Colors.deepPurple, unselectedItemColor: Colors.white),
  ...
  static final lightTheme = ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(backgroundColor: Color.fromARGB(255, 33, 168, 155), selectedItemColor: Colors.white, unselectedItemColor: Colors.black),
    errorColor: Colors.red,
